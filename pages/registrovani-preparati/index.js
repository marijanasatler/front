...
const Index = ({categoriespreparati,preparatis,router}) => {
    ...
    <div className="container-fluid ">
     ...
     <div className='pb-4'  >
         <Link href={`/registrovani-preparati`} >
            ...
            <div>
             ...
             >регистровани препарати</h2>
           </div>      <hr className='' style={{color:'#c1c7e4'}}/>
             {preparatis.length === 0 ? <p className='pt-4' style={{textTransform:'uppercase',fontSize:'',color:'rgb(193, 200, 228)'}}>Тренутно нема регистрованих препарата</p> :
              <p className=' pt-2 ' style={{textTransform:'uppercase',fontSize:'small',textAlign:'',color:'rgb(193, 200, 228)'}} >
            укупно регистрованих препарата:{" "} <b style={{fontSize:'medium'}}>
