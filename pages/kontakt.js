...
const Kontakt = () => {
    ...
    const showKontakt = () => {
      return ostalo.map((o, i) => {
          return (
              <div key={i}  className=' text-muted' style={{}}>
{o.title=== 'kontakt' ? 
              ...
              className='' style={{width:'100%', height:'100%',minHeight:'30vh'}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                ...
                <div  className={styles.kontaktcolumn} > 
                  ...
                  <h4 style={{ margin: 'auto',padding:'0 10px'}}>ЗАВОД ЗА БИОЦИДЕ И <br/>МЕДИЦИНСКУ ЕКОЛОГИЈУ</h4>
                  </div>
                   <div className='mt-3 pl-2'>
                       {renderHTML(o.bodySp)}</div>
                   </div>
    ...
    return (
     ...
     {head()}
        <Layout>
<div className='m-3' style={{minHeight:'55vh'}}>
{showKontakt()}
</div>
