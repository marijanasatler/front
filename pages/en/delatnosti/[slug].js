...
<b className='' style={{color:'#3aafa9'}}>
all activities</b></a>
</Link>
    
{delatnosti.map((d,i) => ( 
  <Link href={`/en/delatnosti/${d.slug}`} key={i}>
  <a className="btn p-0 pl-2 pr-2 mr-1 ml-1  mt-2 mb-2" 
...
>  <b>{d.title}</b></a>
 ...
 <h2 style={{textTransform:'uppercase' ,color:'#3aafa9'}} >{delatnost.titleEn}</h2>
 </div>
  <div className=""><div className='mt-4 mb-4'>
     {renderHTML(delatnost.bodyEn)}</div>
 </div> 
<br/>
 </div>  
 </div><ScrollToTop/>
