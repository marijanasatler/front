...
>  <b className='' style={{color:' #5ab9ea'}}>
all laboratories</b></a>
</Link>
{laboratori.map((l,i) => ( 
    <Link href={`/en/laboratorije/${l.slug}`} key={i}>
  <a className="btn p-0 pl-2 pr-2 mr-1 ml-1  mt-2 mb-2" 
...
><b>{l.titleEn}</b></a>
       ...
       <div className=' ' >
       <h2   className='mt-4 mb-2' style={{textTransform:'uppercase' ,color:' #5ab9ea'}} >{laboratorija.titleEn}</h2>
  </div>
<div className=""><div className='mt-4 mb-4'>
   {renderHTML(laboratorija.bodyEn)}</div>
   </div>        
<br/>
 </div> 
  </div> <ScrollToTop/>
