...
const Index = ({categoriesnabavke,nabavkes,tagnabavkes,totalnabavkes,nabavkesLimit,router}) => {
    ...
    const head = () => (
        <Head>
        <title>Sve nabavke | {APP_NAME}</title>
        <meta
            name="description"
            content="Sve nabavke"/>
        <link rel="canonical" href={`${DOMAIN}${router.pathname}`} />
        <meta property="og:title" content={`Sve nabavke | ${APP_NAME}`} />
        <meta property="og:description" content="Sve nabavke"/>
    ...
    return (
     ...
     <div className=' ' >
         <div className='container-fluid' >
             <div className=''>
        <h2 className=" font-weight-bold text-uppercase  text-muted pl-4 pr-4" style={{color:'#5ab9ea'}}>SVE NABAVKE</h2>          
          <div>
             ...
             <p className='text-muted  pl-4' style={{textTransform:'uppercase',fontSize:'small',textAlign:'',color:'#5ab9ea',}} >
                 UKUPNO NABAVKI:{" "} <b style={{fontSize:'medium'}}> {nabavke.length} </b> </p>}
                 </div>  
           <div className='' >
