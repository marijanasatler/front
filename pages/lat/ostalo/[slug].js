...
const Ostalo = ({ ostalo, query }) => {
    ...
    const head = () => (
        <Head>
            ...
            <link rel="canonical" href={`${DOMAIN}/ostalos/${query.slug}`} />
            <meta property="og:title" content={`${ostalo.title}| ${APP_NAME}`} />
            <meta property="og:description" content={ostalo.mdesc} />
            <meta property="og:type" content="webiste" />
            <meta property="og:url" content={`${DOMAIN}/ostalos/${query.slug}`} />
            <meta property="og:site_name" content={`${APP_NAME}`} />
            <meta property="og:image" content={`${ostalo.imgLink}`} />
            <meta property="og:image:secure_url" content={`${ostalo.imgLink}`} />
